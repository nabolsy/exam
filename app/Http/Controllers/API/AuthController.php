...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if($exam['open']==1){
            return response()->json(['message'=> 'Successfully logged in', 'data'=> ['token'=>$token, 'userInfo'=> $user->toArray(),'currentLevel'=> $exam['current_level']]], 200);
        }else{
            return response()->json(['message'=> 'Successfully logged in', 'data'=> ['token'=>$token, 'userInfo'=> $user->toArray(),'currentLevel'=> null]], 200);
        }
